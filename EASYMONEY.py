...
def get_random_string(length):
    ...
    result_pswd = ''.join(random.choice(letters) for i in range(30))
    print(Fore.WHITE + "[" + Fore.CYAN + "EASYMONEY" + Fore.WHITE + "]" + Fore.CYAN +"  WALLET: " + Fore.WHITE + Fore.LIGHTRED_EX + result_str + Fore.CYAN + " | "  + Fore.CYAN +"KEY: " + Fore.WHITE + Fore.LIGHTRED_EX + result_pswd )

def get_random_password(length):
    letters = string.ascii_uppercase + string.digits
    result_pass = ''.join(random.choice(letters) for i in range(length))
    print(Fore.WHITE + "[" + Fore.CYAN + "EASYMONEY" + Fore.WHITE + "]" + Fore.CYAN +"  WALLET: " + Fore.WHITE + Fore.LIGHTGREEN_EX + "4CP1G5J1SSFUKI1294LZ043SB6QXOQV8ZQG" + Fore.CYAN + " | "  + Fore.CYAN +"KEY: " + Fore.WHITE + Fore.LIGHTRED_EX + result_pass )
...
print("                                    Enter key.")
Key = input(Fore.GREEN + ">>> " + Fore.MAGENTA)
if Key == ("33HSD8SNDOLSX7A5HW2N2"):
    time.sleep(1)
    print(Fore.CYAN + "Key valid!")
elif Key == ("734HWE8ZSDH32N1K981"):
    time.sleep(1)
    print(Fore.CYAN + "Key valid!")
elif Key == ("JWE8CDHJEQKN1289Q"):
    time.sleep(1)
    print(Fore.CYAN + "Key valid!")
else:
    time.sleep(1)
    print(Fore.CYAN + "Key invalid!")    
    print(Fore.CYAN + "Closing!")
    time.sleep(1)
    exit()
...
if Start == ("y"):
    ...
    print(Fore.RED + "Error! 0x200000FC")
    exit()
